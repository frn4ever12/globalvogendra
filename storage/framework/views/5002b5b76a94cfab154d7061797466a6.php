...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['stories' => null]));
...
foreach (array_filter((['stories' => null]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php if($stories && $stories->count() > 0): ?>
    ...
    <div class="container" style="position: relative; z-index: 1;">
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="filter-buttons text-center">
                    ...
                    <?php $__currentLoopData = $stories->pluck('country')->unique(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button class="filter-btn" data-filter="<?php echo e($country); ?>"><?php echo e($country); ?></button>
        ...
        <div class="stories-slider position-relative">
            <div class="stories-container row g-4">
                ...
                <div class="col-lg-4 col-md-6 col-12 story-item" data-country="<?php echo e($story->country); ?>">
                    <div class="story-card" 
                         data-aos="fade-up" 
                         data-aos-delay="<?php echo e($index * 100); ?>"
                         onclick="openStoryModal(<?php echo e($story->id); ?>)">
                        ...
                        <div class="student-photo-wrapper">
                            <?php if($story->student_image): ?>
                                <img src="<?php echo e(asset('storage/' . $story->student_image)); ?>" 
                                     alt="<?php echo e($story->student_name); ?>" 
                                     class="student-photo">
                            <?php else: ?>
                        ...
                        <div class="story-content">
                            <div class="country-badge">
                                ...
                                <span><?php echo e($story->country); ?></span>
                            </div>
                            
                            <h3 class="student-name"><?php echo e($story->student_name); ?></h3>
                            
                            <div class="university-info">
                                <i class="fa fa-university"></i>
                                <span><?php echo e($story->university); ?></span>
                            </div>
                            
                            <div class="course-info">
                                <i class="fa fa-book"></i>
                                <span><?php echo e($story->course); ?></span>
                            </div>
                            
                            <?php if($story->visa_date): ?>
                            <div class="visa-date">
                                <i class="fa fa-calendar"></i>
                                <span><?php echo e($story->visa_date->format('M d, Y')); ?></span>
                            </div>
                            <?php endif; ?>
                            ...
                            <?php if($story->testimonial): ?>
                            <p class="testimonial"><?php echo e(Str::limit($story->testimonial, 80)); ?></p>
                            <?php endif; ?>
...
const totalSlides = <?php echo e($stories->count()); ?>;
...
// Modal functionality
const stories = <?php echo json_encode($stories, 15, 512) ?>;
    ...
    modalBody.innerHTML = `
        <div class="row">
            <div class="col-md-4 text-center">
                ${story.student_image ? 
                    `<img src="<?php echo e(asset('storage/')); ?>${story.student_image}" class="img-fluid rounded-circle mb-3" style="width: 150px; height: 150px; object-fit: cover;">` :
                ...
                ${story.visa_image ? 
                    `<img src="<?php echo e(asset('storage/')); ?>${story.visa_image}" class="img-fluid rounded mb-2" style="max-height: 150px;">` : ''
                }
                ${story.passport_image ? 
                    `<img src="<?php echo e(asset('storage/')); ?>${story.passport_image}" class="img-fluid rounded" style="max-height: 150px;">` : ''
                }
            </div>
            <div class="col-md-8">
                <div class="mb-3">
...
<?php endif; ?>
<?php /**PATH D:\global consultancy\resources\views/components/visa-success-stories-section.blade.php ENDPATH**/ ?>