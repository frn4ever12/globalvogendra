    ...
    <div class="container footer-content">
        <div class="row text-center text-md-start">
            ...
            <div class="col-12 col-md-4 footer-links mb-3">
                ...
                <ul>
                    <li>
                        <a href="mailto:<?php echo e($setting->email ?? 'example@example.com'); ?>">
                            <i class="fas fa-envelope me-2"></i><?php echo e($setting->email ?? 'example@example.com'); ?>

                        </a>
                    </li>
                    <li>
                        <i class="fas fa-phone me-2"></i><?php echo e($setting->phone ?? '+1234567890'); ?>

                    </li>
                    <li>
                        <i class="fas fa-map-marker-alt me-2"></i><?php echo e($setting->address ?? 'Kathmandu, Nepal'); ?>
...
</footer><?php /**PATH D:\global consultancy\resources\views/Frontend/includes/footer.blade.php ENDPATH**/ ?>