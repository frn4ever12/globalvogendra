...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['features' => null]));
...
foreach (array_filter((['features' => null]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php if($features && $features->count() > 0): ?>
<section class="why-choose-us-section py-5" style="background: linear-gradient(135deg, #ffffff 0%, #f8fafc 100%);">
    <div class="container">
        ...
        <!-- Feature Cards -->
        <div class="row g-4">
            <?php $__currentLoopData = $features->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-lg-3 col-md-6 col-12">
                <div class="why-choose-card" 
                     data-aos="<?php echo e($feature->animation ?? 'fade-up'); ?>" 
                     data-aos-delay="<?php echo e($index * 100); ?>"
                     style="background-color: <?php echo e($feature->background_color ?? '#ffffff'); ?>;">
                    
                    <!-- Icon/Image -->
                    <div class="feature-icon-wrapper" style="color: <?php echo e($feature->icon_color ?? '#2563eb'); ?>;">
                        <?php if($feature->image): ?>
                            <img src="<?php echo e(asset('storage/' . $feature->image)); ?>" 
                                 alt="<?php echo e($feature->title); ?>" 
                                 class="feature-image">
                        <?php elseif($feature->icon): ?>
                            <i class="fa fa-<?php echo e($feature->icon); ?> feature-icon"></i>
                        <?php else: ?>
                    ...
                    <!-- Counter -->
                    <?php if($feature->counter): ?>
                    <div class="counter-wrapper">
                        <span class="counter-number" data-target="<?php echo e(preg_replace('/[^0-9]/', '', $feature->counter)); ?>">
                            0
                        </span>
                        <span class="counter-suffix"><?php echo e($feature->counter_suffix ?? ''); ?></span>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="feature-content">
                        ...
                        <p class="feature-description"><?php echo e($feature->short_description); ?></p>
                        
                        <?php if($feature->button_text && $feature->button_link): ?>
                        <a href="<?php echo e($feature->button_link); ?>" class="feature-btn">
                            <?php echo e($feature->button_text); ?>
...
<?php endif; ?>
<?php /**PATH D:\global consultancy\resources\views/components/why-choose-us-section.blade.php ENDPATH**/ ?>