    ...
    <div class="left_col scroll-view">
        <div class="navbar nav_title">
            <a href="{{route('dashboard')}}" class="site_title">
                ...
                <img src="/storage/{{$setting->logo}}" height="32px" width="42px">
                @else
            ...
            <ul class="nav navbar-nav navbar-right header-right" style="width:50%;">
                <li class="">
                    <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown"
                        aria-expanded="false">
                        <img src="{{ $setting && $setting->logo ? '/storage/'.$setting->logo : '/dist/img/logo.jpg' }}" style="width: 40px"  alt="">
                    </a>
                    <ul class="dropdown-menu dropdown-usermenu pull-right">
                        <li>
                            <div style="display: flex;align-items: center; gap:1rem;padding:1rem;">
                                <img src="{{ $setting && $setting->logo ? '/storage/'.$setting->logo : '/dist/img/logo.jpg' }}"
