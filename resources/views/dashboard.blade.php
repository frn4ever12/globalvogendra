...
<div class="stat-cards">
    <x-admin-components.stat-card 
        ...
        value="{{ \App\Models\Country::count() ?? 0 }}" 
        icon="globe" 
        color="primary"
        :trend="'up'"
        :trendValue="'12'"
    ...
    <x-admin-components.stat-card 
        ...
        value="{{ \App\Models\University::count() ?? 0 }}" 
        icon="university" 
        color="success"
        :trend="'up'"
        :trendValue="'8'"
    ...
    <x-admin-components.stat-card 
        ...
        value="{{ \App\Models\Program::count() ?? 0 }}" 
        icon="graduation-cap" 
        color="warning"
        :trend="'up'"
        :trendValue="'15'"
    ...
    <x-admin-components.stat-card 
        title="Total Courses" 
        value="{{ \App\Models\Course::count() ?? 0 }}" 
        icon="book" 
        color="danger"
        :trend="'down'"
        :trendValue="'3'"
    ...
    <x-admin-components.stat-card 
        ...
        value="{{ \App\Models\Service::count() ?? 0 }}" 
        icon="cogs" 
        color="primary"
        :trend="'up'"
        :trendValue="'5'"
    ...
    <x-admin-components.stat-card 
        title="Total Events" 
        value="{{ \App\Models\Event::count() ?? 0 }}" 
        icon="calendar-alt" 
        color="success"
        :trend="'up'"
        :trendValue="'20'"
    ...
    <x-admin-components.stat-card 
        ...
        value="{{ \App\Models\Appointment::count() ?? 0 }}" 
        icon="calendar-check" 
        color="warning"
        :trend="'up'"
        :trendValue="'10'"
